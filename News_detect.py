...
root = tk.Tk()
root.title("Stock Market Price Prediction Using NLP")
...
###########################################################################################################
lbl = tk.Label(root, text="*****___Stock Market Price Prediction Using NLP____*****", font=('times', 35,' bold '), height=1, width=60,bg="red",fg="black")
lbl.place(x=0, y=0)
##############################################################################################################################
...
def Train():
 ...
 ###########################################################################################################################################
    ...
    label5 = tk.Label(root,text ="Accuracy : "+str(ACC)+"%\nModel saved as MLP_MODEL.joblib",width=35,height=3,bg='khaki',fg='black',font=("Tempus Sanc ITC",14))
...
##############################################################################################################################################################################
def Test():
    predictor = load("MLP_MODEL.joblib")
    ...
    print(y_predict[0])
    if y_predict[0]==0:
        label4 = tk.Label(root,text ="It's a True News \n Market is Up",width=20,height=2,bg='#46C646',fg='black',font=("Tempus Sanc ITC",25))
        label4.place(x=450,y=550)
   
    else:
        label4 = tk.Label(root,text ="It's a Fake News \n Market is Down",width=20,height=2,bg='#FF3C3C',fg='black',font=("Tempus Sanc ITC",25))
        label4.place(x=450,y=550)
